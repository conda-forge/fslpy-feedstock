...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fslpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3889&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fslpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fslpy` can be installed with:

```
conda install fslpy
```

It is possible to list all of the versions of `fslpy` available on your platform with:
